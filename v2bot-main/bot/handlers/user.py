...
async def wallet_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        f"📊 <b>تراکنش‌های ۳۰ روز اخیر:</b> {tx_count} مورد\n\n"
        f"💡 <b>راهنما:</b>\n"
        f"• با موجودی کیف پول می‌توانید سرویس خریداری کنید\n"
        f"• شارژ کیف پول به صورت آنی و سریع انجام می‌شود\n\n"
        f"🔽 لطفاً یک روش شارژ را انتخاب کنید:"
    )
    keyboard = [
        [
...
async def support_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        "• پاسخ کارشناسان را دریافت نمایید\n\n"
        "📚 <b>مرکز آموزش:</b>\n"
        "• راهنماهای گام به گام استفاده\n"
        "• ویدیوهای آموزشی تصویری\n\n"
        "⏰ <b>ساعات پاسخگویی:</b>\n"
        "• همه روزه از ساعت ۹ صبح تا ۱۲ شب\n\n"
        "💡 <b>توجه:</b> پیش از ثبت تیکت، لطفاً آموزش‌ها را مطالعه فرمایید."
    )
