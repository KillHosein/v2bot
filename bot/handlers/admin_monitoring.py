...
async def admin_monitoring_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        ...
        [
            InlineKeyboardButton("⚡ مانیتور لحظه‌ای", callback_data='real_time_monitor'),
            InlineKeyboardButton("🌐 IoT دستگاه‌ها", callback_data='iot_management')
        ],
        [
            InlineKeyboardButton("🏗️ Microservices", callback_data='microservices_orchestration'),
            InlineKeyboardButton("🔄 DevOps اتوماسیون", callback_data='devops_automation')
        ],
        [
