...
(
    ...
    WALLET_AWAIT_CUSTOM_AMOUNT_GATEWAY, WALLET_AWAIT_CUSTOM_AMOUNT_CARD, WALLET_AWAIT_CUSTOM_AMOUNT_CRYPTO,
    WALLET_AWAIT_SCREENSHOT, # v3.0: New wallet upload flow
    # Admin Stats
    ADMIN_STATS_MENU,
    ...
    # Backup
    BACKUP_CHOOSE_PANEL, BACKUP_RESTORE_AWAIT_FILE,
    ...
    # Plan binding to panel/inbound
    ADMIN_PLAN_BIND_PANEL, ADMIN_PLAN_BIND_INBOUND,
    # Support
    SUPPORT_AWAIT_TICKET, ADMIN_AWAIT_TICKET_REPLY,
    # Reseller
    RESELLER_AWAIT_UPLOAD, ADMIN_RESELLER_MENU, ADMIN_RESELLER_AWAIT_VALUE,
    # Users Management
    ADMIN_USERS_MENU, ADMIN_USERS_AWAIT_SEARCH,
    # Cron Settings
    ADMIN_CRON_MENU, ADMIN_CRON_AWAIT_HOUR,
    __RESERVED_UNUSED_STATE1, __RESERVED_UNUSED_STATE2,
) = range(90)